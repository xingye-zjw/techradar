...
const B_D2L_LIMU: ResourceLink = { title: "【李沐】动手学深度学习V2（PyTorch版）", url: "https://www.bilibili.com/video/BV1f54ZzGEMC", required: false, type: "video", source: "bilibili", duration: "50h" };
const B_LINEAR_ALGEBRA: ResourceLink = { title: "【3Blue1Brown】线性代数的本质", url: "https://www.bilibili.com/video/BV1sW4y1Z7bE", required: false, type: "video", source: "bilibili", duration: "3h" };
...
const B_NLP_TUTORIAL: ResourceLink = { title: "【李宏毅】NLP自然语言处理", url: "https://www.bilibili.com/video/BV17sJzzMEuj", required: false, type: "video", source: "bilibili", duration: "10h" };
const B_LLM_FINETUNE: ResourceLink = { title: "【李宏毅】2026机器学习（LLM微调）", url: "https://www.bilibili.com/video/BV1cpju6TEtc", required: false, type: "video", source: "bilibili", duration: "20h" };
