...
export const LEARNING_PATHS: LearningPath[] = [
  {
    id: 'cv-path',
    name: '计算机视觉路径',
    description: '从零开始学习计算机视觉，掌握 CNN、目标检测、姿态估计、扩散模型等核心技术',
    nodes: ['linux-basic', 'git-github', 'docker-basic', 'math-linear-algebra', 'math-probability', 'pytorch-core', 'cv-cnn', 'cv-detection', 'cv-pose-estimation', 'cv-diffusion'],
    duration: '16 周',
  ...
  },
  {
    ...
    nodes: ['linux-basic', 'git-github', 'docker-basic', 'math-linear-algebra', 'math-probability', 'pytorch-core', 'nlp-rnn'],
    duration: '10 周',
    difficulty: 'intermediate',
    category: 'nlp',
  },
  {
    ...
    nodes: ['linux-basic', 'git-github', 'docker-basic', 'devops-docker-api', 'devops-kubernetes', 'devops-monitoring'],
    duration: '10 周',
    difficulty: 'intermediate',
    category: 'devops',
  },
  ...
  },
  {
    ...
    nodes: ['linux-basic', 'git-github', 'cs-algo', 'cs-os'],
    duration: '8 周',
    difficulty: 'beginner',
    category: 'cs',
  },
  {
    ...
    nodes: ['linux-basic', 'git-github', 'embedded-c', 'embedded-rtos', 'embedded-hal'],
    duration: '10 周',
    difficulty: 'intermediate',
    category: 'embedded',
  },
  {
    ...
    nodes: ['elec-circuit', 'elec-signals', 'elec-digital'],
    duration: '8 周',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    nodes: ['math-linear-algebra', 'math-probability', 'signals-comm'],
    duration: '6 周',
    difficulty: 'intermediate',
    category: 'signals',
  },
  ...
  },
  {
    ...
    nodes: ['elec-circuit', 'elec-motor', 'electrical-power', 'electrical-safety'],
    duration: '10 周',
    difficulty: 'intermediate',
    category: 'electrical',
  },
