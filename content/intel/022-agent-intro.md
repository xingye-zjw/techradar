...
01. 检查工具描述是否清晰，Agent 是否能正确选择工具
02. 确认工具返回格式稳定，避免模型解析失败
03. 观察 Thought-Action-Observation 循环，定位错误步骤
04. 调整 prompt，明确 Agent 的目标和约束
05. 引入记忆组件，避免上下文丢失
06. 对复杂任务使用 Plan-and-Solve 或 LangGraph 构建状态机
07. 设置最大迭代次数和 human-in-the-loop 确认，防止无限循环
